  ...
  <fragment>
    ...
    >
      <validation-observer ref="form">
        <validation-provider name="material_id" v-slot="{ errors, valid }">
          <v-autocomplete
        ...
        >
          <template v-slot:activator="{ on, attrs }">
            <validation-provider name="changed_at" v-slot="{ errors, valid }">
              <v-text-field
          ...
          >
            <v-spacer></v-spacer>
            <v-btn text color="primary" @click="menuChangedAt = false"
              >Cancel</v-btn
            >
            <v-btn
              text
