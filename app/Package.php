...
class Package extends Model
{
    ...
    protected $client_relations = ['user:id,name', 'unit', 'rev'];
    protected $client_details = ['revs', 'revs.user:id,name', 'packagers', 'packagers.packets', 'packagers.packer:id,name'];
    protected $client_counts = ['revs', 'packagers'];
